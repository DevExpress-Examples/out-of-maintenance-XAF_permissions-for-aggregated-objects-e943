...
Namespace AggregatedObjects.Win
	Partial Public Class AggregatedObjectsWindowsFormsApplication
		...
		Private Sub AggregatedObjectsWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
